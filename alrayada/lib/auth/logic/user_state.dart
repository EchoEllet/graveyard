...
sealed class UserState extends Equatable {
  ...
  /// Check if the user was logged in and is now logged out
  bool wasLoggedInAndNowLoggedOut({required UserState previous}) =>
      previous.userCredential != null && userCredential == null;

  @override
  List<Object?> get props => [userCredential];
}

// TODO: This might be unnecessary if we have UserLoggedOut
