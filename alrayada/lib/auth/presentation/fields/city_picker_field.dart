...
import 'package:flutter_platform_widgets/flutter_platform_widgets.dart'
    show PlatformIconButton, PlatformTextButton;
...
class CityPickerFormField extends StatefulWidget {
  ...
  /// Decide if we should override the [initialCity] with the last
  /// city located by GPS.
  ///
  /// `true` for sign in/up (e.g., [AuthSocialLoginSignUpScreen])
  ///
  /// `false` for [ProfileScreen]
