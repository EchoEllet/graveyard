...
import 'auth_form.dart' show AuthenticationForm;
import 'auth_social_login.dart';
import 'fields/email_text_field.dart';
import 'fields/password_text_field.dart';
import 'fields/privacy_policy_field.dart';
import 'fields/user_info_text_inputs.dart';
...
class _AuthFormInputsState extends State<AuthFormInputs> {
  ...
  var _isLogin = AuthenticationForm.initialIsLogin;
  ...
  void initState() {
    ...
    // Set initial input during development only
    if (kDebugMode) {
      if (getEnvironmentVariables().isProductionMode) {
        return;
      }
      _emailController.text = 'user@gmail.com';
      _passwordInputHandler.controller.text = '?Rocej2dr!zL+wiDlni4';
      _confirmPasswordInputHandler.controller.text = '?Rocej2dr!zL+wiDlni4';
      _labOwnerPhoneNumberInputHandler.controller.text = '07054726510';
      _labPhoneNumberController.text = '07054726510';
      _labNameController.text = 'My Lab Name';
      _labOwnerNameController.text = 'My name';
