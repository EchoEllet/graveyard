...
class RemoteUserApi extends UserApi {
  ...
  /// Common exception handling for user actions such as [updateUserInfo]
  /// and [sendEmailVerificationLink]
  void _handleCommonHttpExceptions(DioException e) {
  ...
  /// Shared code between [signInWithEmailAndPassword], [signUpWithEmailAndPassword]
  /// and [authenticateWithSocialLogin]
  ...
  Future<void> onInvalidToken() async {
    await logout();
    onAutoLogout?.call();
  }
  ...
  @override
  Future<void> setOnAutoLogout(void Function() onAutoLogout) async {
  ...
  Future<User?> fetchUser() async {
    try {
      ...
      _handleCommonHttpExceptions(e);
      throw UnknownUserException(message: e.toString());
    } on UserNotLoggedInAnyMoreUserException {
      // TODO: Probably not being triggered?
      print("You're no longer authenticated in Remote User Api");
